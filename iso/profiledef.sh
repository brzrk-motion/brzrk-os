...
iso_name="brzrk"
iso_label="BRZRK_$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y%m)"
iso_publisher="BRZRK OS <https://github.com/brzrk-motion/brzrk-os>"
iso_application="BRZRK OS Creative Workstation Live/Install DVD"
